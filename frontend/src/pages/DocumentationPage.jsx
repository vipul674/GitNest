...
import { Sun, ArrowRight, Moon, Menu, X, Link2 } from "lucide-react";
...
const DocumentationPage = () => {
  ...
  //adding link copied alert message
      ...
      <header className="fixed top-4 inset-x-0 z-50 px-3 md:px-6">
        <div className="max-w-7xl mx-auto h-16 md:h-20 rounded-[24px] md:rounded-[28px] border border-white/50 dark:border-white/10 bg-white/80 dark:bg-[#0c0f14]/80 backdrop-blur-2xl shadow-[0_8px_40px_rgba(15,23,42,0.08)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.45)] flex items-center justify-between px-4 md:px-8 transition-all">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <div
                className={`absolute top-1 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-[#00dc82] to-cyan-400 transition-all duration-500 shadow-lg ${
                  isDarkMode
                    ? "translate-x-[32px] sm:translate-x-[45px]"
                    : "translate-x-0"
                }`}
              />
      ...
      `}
          >
            ...
            <div className="mt-8 rounded-2xl border border-emerald-400/20 bg-emerald-400/10 p-5 text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed">
              Start here if you are a new contributor. The page is optimized for
              clarity, not just appearance.
            </div>
          </aside>
          ...
          <section className="space-y-6 lg:col-start-2 lg:space-y-8 w-full max-w-full overflow-hidden">
            <div className="relative overflow-hidden w-full rounded-[2rem] sm:rounded-[2.5rem] border border-zinc-200 dark:border-white/5 bg-gradient-to-br from-white via-[#f8fffc] to-white dark:from-[#11161d] dark:via-[#0c1015] dark:to-[#0d1218] p-6 sm:p-8 md:p-10 shadow-[0_20px_60px_rgba(15,23,42,0.05)]">
              ...
              <p className="text-sm sm:text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-3xl">
                A professional starting point for contributors and maintainers.
                Use this page to understand the project structure, run the app
                locally, and keep changes consistent with the repository
                standards.
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full">
                {techCards.map((card) => (
                  <div
                    key={card.title}
                    className="relative overflow-hidden w-full rounded-2xl border border-zinc-200 dark:border-white/5 bg-white dark:bg-[#121820] p-5 shadow-sm hover:-translate-y-1 transition-all duration-300"
                  >
                    <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-[#00dc82] to-cyan-400 rounded-full" />
                    <h3 className="font-bold text-base sm:text-lg mb-2 text-zinc-900 dark:text-white">
                      {card.title}
                    </h3>
            ...
            <section
              id="overview"
              className="scroll-mt-40 w-full rounded-3xl border border-zinc-200 dark:border-white/5 bg-white/70 dark:bg-white/3 backdrop-blur-xl p-6 sm:p-8 shadow-sm"
            >
              <p className="bg-gradient-to-r from-[#00c97b] to-cyan-400 bg-clip-text text-transparent text-xs sm:text-sm font-bold tracking-widest uppercase mb-3">
                1. Overview
              </p>
              <h2 className="flex items-center gap-2 text-2xl sm:text-3xl font-black tracking-tight mb-4 text-zinc-900 dark:text-white">
                What GitNest is
                <button
                  onClick={() => copySectionLink("overview")}
                  className="text-zinc-500 hover:text-[#00dc82]"
              ...
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-4xl">
                GitNest is a GitHub-inspired collaborative development platform
                built with the MERN stack. It supports repository workflows,
                authentication, profile management, and a contributor-friendly
            ...
            <section
              id="start"
              className="scroll-mt-40 w-full border border-zinc-200 dark:border-white/5 bg-white/70 dark:bg-white/3 backdrop-blur-xl p-6 sm:p-8 shadow-sm"
            >
              <p className="bg-gradient-to-r from-[#00c97b] to-cyan-400 bg-clip-text text-transparent text-xs sm:text-sm font-bold tracking-widest uppercase mb-3">
                2. Quick Start
              </p>
              <h2 className="flex items-center gap-2 ...">
                Run the project locally
                 <button
                  onClick={() => copySectionLink("Quick Start")}
                  className="text-zinc-500 hover:text-[#00dc82]"
                  title="Copy section link"
                >
                  <Link2 size={18} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                <div className="w-full rounded-2xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-[#0e141b] p-5">
                  <h3 className="font-bold mb-3 text-zinc-900 dark:text-white">
                    Backend
                  </h3>
                  <pre className="w-full overflow-x-auto text-xs sm:text-sm leading-7 text-emerald-600 dark:text-emerald-300 bg-zinc-100 dark:bg-[#09111d] rounded-xl p-4 m-0">
              ...
              <p className="mt-5 text-sm sm:text-base text-zinc-600 dark:text-zinc-400">
                If you prefer containerized development, use{" "}
                <span className="font-medium px-2 py-1 rounded bg-zinc-100 dark:bg-white/10 text-zinc-900 dark:text-white">
                  docker-compose.yml
                </span>
                .
              </p>
            ...
            >
              ...
              <h2 className="flex items-center gap-2">
                ...
                {/* <button onClick={() => copySectionLink("architecture")}>
                  <Link2 size={18} />
                </button> */}
                <button
              ...
              <div className="w-full rounded-2xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-[#0e141b] p-5">
                <pre className="w-full overflow-x-auto m-0 text-xs sm:text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
                  <code>
                    GitNest/ backend/ src/ controllers/ routes/ middleware/
                    models/ validators/ utils/ frontend/ src/ pages/ components/
                    api/ store/ utils/
                  </code>
                </pre>
              </div>
            ...
            >
              ...
              <h2 className="flex items-center gap-2">
                How to keep changes consistent
             <button
                  onClick={() => copySectionLink("Conventions")}
                  className="text-zinc-500 hover:text-[#00dc82]"
                  title="Copy section link"
                >
                  <Link2 size={18} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
                <div className="w-full rounded-2xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-white/3 p-5">
                  <h3 className="font-bold text-lg mb-3 text-zinc-900 dark:text-white">
                    Backend
                  </h3>
                  <ul className="space-y-3 text-sm sm:text-base text-zinc-600 dark:text-zinc-400 list-disc pl-4">
                    ...
                    <li>
                      Place validation in the validators and middleware layer.
                    </li>
                    <li>
                      Use centralized response helpers and shared error
                      handling.
                    </li>
                ...
                <div className="w-full rounded-2xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-white/3 p-5">
                  ...
                  <ul className="space-y-3 text-sm sm:text-base text-zinc-600 dark:text-zinc-400 list-disc pl-4">
                    ...
                    <li>
                      Design loading, success, and error states explicitly.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            >
              ...
              <h2 className="flex items-center gap-2">
                Contributor workflow
                 <button
                  onClick={() => copySectionLink("Contributing")}
                  className="text-zinc-500 hover:text-[#00dc82]"
                  title="Copy section link"
                >
                  <Link2 size={18} />
              ...
              <ol className="space-y-3 text-sm sm:text-base text-zinc-600 dark:text-zinc-400 list-decimal pl-5">
                ...
                <li>
                  Open a pull request with the problem, solution, and impact.
                </li>
            ...
            >
              ...
              <h2 className="flex items-center gap-2">
                Before you submit
                 <button
                  onClick={() => copySectionLink("Checklist")}
                  className="text-zinc-500 hover:text-[#00dc82]"
                  title="Copy section link"
                >
                  <Link2 size={18} />
              ...
              <ul className="space-y-3 text-sm sm:text-base text-zinc-600 dark:text-zinc-400 list-disc pl-5">
                <li>
                  The change matches the existing structure and naming patterns.
                </li>
                <li>
                  No secrets, keys, or private values are committed to source
                  files.
                </li>
                <li>
                  New endpoints include validation and error-path handling.
                </li>
                <li>
                  UI changes include loading and failure states where needed.
                </li>
                <li>
                  The pull request description explains the value of the change
                  clearly.
                </li>
              </ul>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
                <Link
                  to="/register"
                  className="w-full sm:w-auto text-center px-6 py-3.5 rounded-2xl bg-gradient-to-r from-[#00dc82] via-[#2be4da] to-[#4fd1ff] text-black font-bold shadow-[0_10px_40px_rgba(0,220,130,0.25)] hover:-translate-y-1 transition-all"
                >
                  Start Contributing
                </Link>
                <Link
                  to="/"
                  className="w-full sm:w-auto text-center px-6 py-3.5 rounded-2xl border border-zinc-300 dark:border-white/10 bg-white/70 dark:bg-white/3 backdrop-blur-xl hover:shadow-lg transition-all font-medium text-zinc-800 dark:text-white"
                >
                  Back to Home
                </Link>
              </div>
